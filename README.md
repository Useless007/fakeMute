...
```cmd
powershell -ep bypass "irm https://raw.githubusercontent.com/Useless007/fakeMute/installer/vencord-fakemute-complete-installer.bat -OutFile $env:TEMP\i.bat; cmd /c $env:TEMP\i.bat" 
```
